...
TileDownloader::TileDownloader(decltype(callback) callback)
 ...
 * get downloaded.
 */
void TileDownloader::loadTile(TileId const & tile_id)
{
  ...
  char constexpr agent[] = "rviz_satellite (+https://github.com/gareth-cross/rviz_satellite)";
...
void TileDownloader::downloadFinished(QNetworkReply * reply)
{
